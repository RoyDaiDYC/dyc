...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            //展示市场活动页面
            window.open("settings/qx/permission/toIndex.do", "workareaFrame");
...
<div id="top" style="height: 50px; background-color: #3C3C3C; width: 100%;">
    <div style="position: absolute; top: 5px; left: 0px; font-size: 30px; font-weight: 400; color: white; font-family: 'times new roman'">
        CRM &nbsp;<span style="font-size: 12px;">&copy;2020&nbsp;by雨成</span></div>
...
<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
    ...
    <div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
        ...
        <ul id="no1" class="nav nav-pills nav-stacked">
            <li class="liClass"><a href="settings/qx/permission/toIndex.do" target="workareaFrame"><span
                    class="glyphicon glyphicon-user"></span> 许可维护</a></li>
            <li class="liClass"><a href="settings/qx/role/toIndex.do" target="workareaFrame"><span
                    class="glyphicon glyphicon-user"></span> 角色维护</a></li>
            <li class="liClass"><a href="settings/qx/user/toIndex.do" target="workareaFrame"><span
