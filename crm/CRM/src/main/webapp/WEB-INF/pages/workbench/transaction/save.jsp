    ...
    <script type="text/javascript">
        $(function () {
            ...
            function checkCreateOwner() {
                var createOwner = $("#create-transactionOwner").val();
                if (createOwner === "") {
                    $("#createOwnerMsg").html("拥有着不能为空");
            ...
            function checkCreateMoney() {
                var createMoney = $.trim($("#create-amountOfMoney").val());
                if (createMoney === "" || /^\d+$/.test(createMoney)) {
                    $("#createMoneyMsg").html("");
                    checkCreateFormFlag = true;
                } else {
                    $("#createMoneyMsg").html("金额填写只能是非负整数");
                    checkCreateFormFlag = false;
                }
                return checkCreateFormFlag;
            }
            ...
            function checkCreateName() {
                var createName = $.trim($("#create-transactionName").val());
                if (createName === "") {
            ...
            function checkCreateExpectedClosingDate() {
                var expectedDate = $("#create-expectedClosingDate").val();
                if (expectedDate === "") {
                    $("#createExpectedDateMsg").html("预计成交日期不能为空");
                    checkCreateFormFlag = false;
                } else {
                    $("#createExpectedDateMsg").html("");
                    checkCreateFormFlag = true;
                }
                return checkCreateFormFlag;
            }

            function checkCreateCustomerName() {
                var createCustomerName = $.trim($("#create-customerName").val());
                if (createCustomerName === "") {
                    $("#createCustomerNameMsg").html("客户名称不能为空");
                    checkCreateFormFlag = false;
                } else {
                    $("#createCustomerNameMsg").html("");
                    checkCreateFormFlag = true;
                }
                return checkCreateFormFlag;
            }

            function checkCreateStage() {
                var createStage = $("#create-transactionStage").val();
                if (createStage === "") {
                    $("#createStageMsg").html("阶段不能为空");
                    checkCreateFormFlag = false;
                } else {
                    $("#createStageMsg").html("");
                    checkCreateFormFlag = true;
            ...
            $("#create-transactionOwner").mousedown(function () {
                checkCreateOwner();
            });
            $("#create-amountOfMoney").blur(function () {
                checkCreateMoney();
            });
            $("#create-transactionName").blur(function () {
                checkCreateName();
            });
            $("#create-expectedClosingDate").mouseleave(function () {
                checkCreateExpectedClosingDate();
            });
            $("#create-customerName").blur(function () {
                checkCreateCustomerName();
            });
            $("#create-transactionStage").mousedown(function () {
                checkCreateStage();
            });

            function checkCreateForm() {
                checkCreateFormFlag = checkCreateOwner() && checkCreateMoney() &&
                    checkCreateName() && checkCreateExpectedClosingDate() &&
                    checkCreateCustomerName() && checkCreateStage();
                return checkCreateFormFlag;
            }
           ...
           * */
            ...
            //给保存按钮添加点击事件
            $("#saveCreateTransactionButton").click(function () {
                //收集参数
...
<div style="position:  relative; left: 30px;">
    ...
    <div style="position: relative; top: -40px; left: 70%;">
        <button id="saveCreateTransactionButton" type="button" class="btn btn-primary">保存</button>
...
<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            ...
            <span id="createMoneyMsg" style="color: red"></span>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <label for="create-expectedClosingDate" class="col-sm-2 control-label">预计成交日期<span
                style="font-size: 15px; color: red;">*</span></label>
        <div class="col-sm-10" style="width: 300px;">
            <input type="text" class="form-control myDate1" id="create-expectedClosingDate" readonly>
            <span id="createExpectedDateMsg" style="color: red"></span>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            <c:if test="${not empty customerName}">
                <input type="text" class="form-control" id="create-customerName" value="${customerName}" readonly>
            </c:if>
            <c:if test="${empty customerName}">
                <input type="text" class="form-control" id="create-customerName" placeholder="支持自动补全，输入客户不存在则新建">
            </c:if>
            <c:if test="${not empty customerId}">
                <input id="create-customerId" type="hidden" value="${customerId}">
            </c:if>
            <c:if test="${empty customerId}">
                <input id="create-customerId" type="hidden">
            </c:if>
            <span id="createCustomerNameMsg" style="color: red"></span>
        </div>
        ...
        <div class="col-sm-10" style="width: 300px;">
            ...
            <span id="createStageMsg" style="color: red"></span>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <label for="create-activityName" class="col-sm-2 control-label">市场活动源&nbsp;&nbsp;<a id="searchActivityBtn"
    ...
    <div class="form-group">
        <label for="create-contactsName" class="col-sm-2 control-label">联系人名称&nbsp;&nbsp;
            <c:if test="${not empty contactsName}">
                <span class="glyphicon glyphicon-search"></span>
            </c:if>
            <c:if test="${empty contactsName}">
        ...
        <div class="col-sm-10" style="width: 300px;">
            ...
            <c:if test="${not empty contactsId}">
                <input id="create-contactsId" type="hidden" value="${contactsId}">
            </c:if>
            <c:if test="${empty contactsId}">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            <input type="text" class="form-control myDate2" id="create-nextContactTime" readonly>
        </div>
    </div>
