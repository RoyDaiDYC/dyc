    ...
    <div class="modal-dialog" role="document" style="width: 30%;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button id="safeLoginOutButton" type="button" class="btn btn-primary" data-dismiss="modal">确定</button>
            </div>
        </div>
    </div>
</div>
...
<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
    ...
    <div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
        ...
        <ul id="no1" class="nav nav-pills nav-stacked">
            <li class="liClass"><a href="settings/dictionary/type/toIndex.do" target="workareaFrame"><span
                    class="glyphicon glyphicon-book"></span> 字典类型</a></li>
            <li class="liClass"><a href="settings/dictionary/value/toIndex.do" target="workareaFrame"><span
